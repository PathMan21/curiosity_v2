...
//         try {
//             privateApi.post('/updated-profile', { username: username, interests: interests, picture: picture }).then((response) => {

//                 if (response.data.status !== "Success") {

//                     return `Erreur : ${response}`;
//                 } else {
//                     updateProfile(response.data.accessToken, response.data.refreshToken)

...
import { authentificatedUser, validateUserOauth } from "../Middlewares/user.middlewares";
...
router.post("/complete-inscription-oauth", bodyParser.json(), validateUserOauth, authentificatedUser, updateProfile);
